...
struct SoundInfo COMMON(gSoundInfo) gSoundInfo = { 0 };

MPlayFunc COMMON(gMPlayJumpTable) gMPlayJumpTable[36] = { 0 };

struct CgbChannel COMMON(gCgbChans) gCgbChans[4] = { { 0 } };

u8 COMMON(gMPlayMemAccArea) gMPlayMemAccArea[0x10] = { 0 };
